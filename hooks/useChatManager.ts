...
export const useChatManager = ({ settings, onSetTheme, onSetSettings, onShowProgress, generateTestFromContent }: UseChatManagerProps) => {
...
// Fix: Explicitly type the caught error to 'any' to avoid issues with 'unknown' type in strict mode.
    ...
    }, [input, uploadedFiles, messages, settings, onSetTheme, onSetSettings, onShowProgress, generateTestFromContent]);
