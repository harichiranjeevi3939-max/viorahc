    ...
    return (
        <div className="flex-shrink-0 w-full px-4 pt-2 pb-4">
            <div className="w-full max-w-3xl mx-auto">
                ...
                <div className={`relative flex items-end gap-2 p-2 rounded-2xl shadow-lg transition-colors duration-300 border backdrop-blur-lg ${props.theme === 'professional' ? 'bg-white/20 border-white/20' : 'bg-black/10 border-white/5'}`}>
                    {props.settings.enable2CMode && <PersonalityIndicator theme={props.theme} personality={props.currentPersonality} />}
